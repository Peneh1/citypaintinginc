<div class="col-md-6 col-xl-5 offset-xl-2">
          <div class="box-form bg-white">
            ...
            <form class="rd-form rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
              ...
              <div class="form-wrap">
                <div class="form-input-icon">
                  <svg class="icon-fill" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="form-wrap">
                ...
                <svg class="icon-fill" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd" class="comments-svg" d="M17.3,8.2c0,4-3.7,7.2-8.3,7.2c-0.8,0-1.5-0.1-2.3-0.3c0,0-1.4,1.8-3.8,1.8C4.1,15.3,4.1,14,4.1,14
	C2,12.7,0.7,10.6,0.7,8.2c0-4,3.7-7.2,8.3-7.2C13.6,1.1,17.3,4.3,17.3,8.2z"/>
    
                </svg>
                <style type="text/css">.comments-svg{fill:none;stroke:#000000;stroke-width:1.8586;stroke-miterlimit:10;}</style>
